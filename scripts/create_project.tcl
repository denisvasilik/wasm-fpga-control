...
set project_name "WasmFpgaControl"
...
set obj [get_filesets sources_1]
set files_vhd [list \
 [file normalize "${project_src}/WasmFpgaControl.vhd" ]\
 [file normalize "${project_src}/WasmFpgaControlPackage.vhd" ]\
...
set obj [get_filesets sources_1]
set_property -name "top" -value "WasmFpgaControl" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_file" -value "${project_src}/WasmFpgaControl.vhd" -objects $obj
...
set files [list \
 "[file normalize "${project_tb}/tb_WasmFpgaControl.vhd"]"\
...
set obj [get_filesets sim_1]
set_property "top" "tb_WasmFpgaControl" $obj
